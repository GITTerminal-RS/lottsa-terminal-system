...
import carrito from "../../assets/bus.png";
import logo from "../../assets/tt.png";
import { MdOutlineInfo, MdArrowBack } from "react-icons/md";
      ...
      <div className="contentCard">
        <div className="card">
       {
        state && <RegistrarAdmin setState={()=>setState(!state)}/>
          ...
          <Titulo>LOTTSA</Titulo>
          {stateInicio && (
            <TextoStateInicio>datos incorrectos</TextoStateInicio>
          )}
          <span className="ayuda">
            {" "}
            Solicita al adminisitrador<br></br> crear una cuenta y empieza publicar.<MdOutlineInfo />
          </span>
          <p className="frase">Gestion de información.</p>
          <form onSubmit={handleSubmit(iniciar)}>
            ...
            <ContainerBtn>
              <Btnsave titulo="Iniciar" bgcolor="#80d4ff" />

...
import { CardDatosOperadora } from "../moleculas/CardDatosOperadora";
import { useOperadoraStore } from "../../store/OperadoraStore";
import { useState } from "react";

export function BannerOperadora() {
  const {dataoperadora,contadorusuarios} = useOperadoraStore();
  return (
    <Container>
      <div className="content-wrapper-context">
        <span className="titulo">
          {<v.iconooperadora />}
          {dataoperadora?.nombre}
        </span>
        <div className="content-text">
          LOTTSA te mantiene siempre informado.
        </div>
        <ContentCards>
          <CardDatosOperadora titulo="Dirección" valor={dataoperadora?.direccion} />
          
          <CardDatosOperadora titulo="Usuarios" valor={contadorusuarios} />
